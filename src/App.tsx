...
const AllProjectsClientPage = lazy(
    () => import("@/pages/client-pages/All-projects-client/All-projects-client-page")
);
...
const FreelancerProjectsPage = lazy(
    () => import("@/pages/freelancer-pages/Freelancer-projects/Freelancer-projects-page")
);
...
const ClientProfileFreelancerPage = lazy(
    () =>
        import(
            "@/pages/freelancer-pages/Client-profile-freelancer/Client-profile-freelancer-page"
        )
);

// common pages
const ChatPage = lazy(() => import("@/pages/Chat/Chat-page"));
const ProjectChatsPage = lazy(() => import("@/pages/Chat/Project-chat-page"));
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                element: <ClientProfileFreelancerPage />
            }
        ],
    },
]);
