...
const FreelancerProfilePage = () => {
    ...
    return (
        <div>
            ...
            {data && (
                <div className="flex justify-center items-center px-4 py-6 bg-gray-50">
                    <div className="w-full max-w-5xl bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-10 flex flex-col md:flex-row items-center md:items-start gap-6">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {data.skills.map(
                                            (skill: string, index: number) => (
                                                <span
                                                    key={index}
                                                    className="px-3 py-1 bg-[var(--my-blue)]/10 text-[var(--my-blue)] font-medium rounded-full text-sm shadow-sm hover:bg-[var(--my-blue)]/20 transition-colors"
                                                >
                                                    {skill}
                                                </span>
                                            )
